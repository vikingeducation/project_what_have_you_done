...
/*
DO LEGISLATOR QUERY FOR picture, first_name, last_name,
...
// WORKS!!!
/*
function billInfoRequestComplete(bioguide_id) {
  billInfoRequest(bioguide_id)
  .then(
...
//billInfoRequestComplete("H001053");

//billInfoRequestComplete("H001053");



// Test 3: Retrieve legislator specific info with bioguide_id
/*
legislatorInfo("W000812")
.then((result) => {
  console.log(result);
});
*/
